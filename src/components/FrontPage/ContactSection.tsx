...
const ContactSection: React.FC = () => {
  ...
  return (
    <div className="container 2xl:max-w-[1320px] mx-auto px-[12px] py-[60px] md:py-[80px] lg:py-[100px] xl:py-[150px]">
      <div className="grid grid-cols-1">
        <div>
          <div className="mb-[25px] md:mb-[30px] lg:mb-[35px] xl:mb-[40px] md:max-w-[540px] lg:max-w-full text-center">
