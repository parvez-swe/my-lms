      ...
      try {
        ...
        if (result.success) {
          const pricingType =
            ...
            (result.data.price === "$0" ||
            result.data.price?.toLowerCase() === "free"
              ? "free"
              : "paid");
          setFormData({ ...result.data, pricingType });
            ...
            <div className="trezo-card-content space-y-[20px]">
              {formData.faqs && formData.faqs.length > 0 ? (
                      ...
                      <div className="flex-1 space-y-3">
                        <div>
                          ...
                          <input
                            ...
                            placeholder="Who should join this course?"
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            rows={3}
                            placeholder="Provide a concise answer that helps potential students."
                ...
                <p className="text-sm text-gray-500">
                  No FAQs yet. Add a few to answer common student questions.
                </p>
              )}
            </div>
          </div>
                    ...
                    {module.lessons.map((lesson, lessonIndex) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            type="checkbox"
                            id={`privacy-edit-${moduleIndex}-${lessonIndex}`}
                          ...
                          />
                          <label
                            htmlFor={`privacy-edit-${moduleIndex}-${lessonIndex}`}
