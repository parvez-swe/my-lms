...
import ContactPage from "@/app/(client)/contact/page"; // Import the new ContactPage
      ...
      <div className="front-page-body overflow-hidden">
        ...
        <div className="pt-[125px] md:pt-[145px] lg:pt-[185px] xl:pt-[195px] text-center">
          <div className="container 2xl:max-w-[1320px] mx-auto px-[12px] relative z-[1]">
            ...
            <div className="absolute bottom-0 -z-[1] ltr:-right-[30px] rtl:-right-[30px] blur-[250px]">
              <Image
            ...
            <div className="absolute -top-[220px] -z-[1] ltr:-left-[50px] rtl:-left-[50px] blur-[150px]">
              <Image
        ...
        <ContactPage /> {/* Use the new ContactPage */}
        <Cta />
        <Footer />
      </div>
    </>
